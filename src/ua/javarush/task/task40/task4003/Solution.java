package ua.javarush.task.task40.task4003;
...
public class Solution {
    ...
    public void sendMail(final String username, final String password, final String recipients) {
        ...
        try {
            ...
            setSubject(message, "Тестовий лист");
            setAttachment(message, "c:/text.txt");

            Transport.send(message);

            System.out.println("Лист був відправлений.");
        } catch (MessagingException e) {
            System.out.println("Помилка при відправці: " + e.toString());
        }
    }
