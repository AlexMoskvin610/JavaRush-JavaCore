...
public class QueryEntry {
    ...
    public boolean equals(Object o) {
        ...
        return queryType == that.queryType && queryFilter == that.queryFilter && Objects.equals(startDate, that.startDate) && Objects.equals(endDate, that.endDate);
    }

    @Override
    public int hashCode() {
        return Objects.hash(queryType, queryFilter, startDate, endDate);
    }
