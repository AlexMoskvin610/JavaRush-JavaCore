...
public final class ReflectionAnnotationUtil {
    ...
    private static void processLongPositiveAnnotationField(Object someObject, Class<?> testedClass, Field field) throws
        ...
        if (!fieldType.equals(long.class)) {
            String msg = String.format("Поле %s в класі %s має анотацію LongPositive, але його тип %s.",
        ...
        if (value <= 0) {
            String msg = String.format("Поле %s в класі %s має анотацію LongPositive, але його значення не додатнє.",
